...
require_relative "lib/exhaustive_case/version"

Gem::Specification.new do |spec|
  spec.name = "exhaustive_case"
  spec.version = ExhaustiveCase::VERSION
  ...
  spec.homepage = "https://github.com/ajsharma/exhaustive_case"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.0.0"

  spec.metadata["allowed_push_host"] = "https://rubygems.org"
  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/ajsharma/exhaustive_case"
  spec.metadata["changelog_uri"] = "https://github.com/ajsharma/exhaustive_case/blob/main/CHANGELOG.md"
